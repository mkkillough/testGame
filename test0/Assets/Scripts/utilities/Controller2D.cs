...
public class Controller2D : RaycastController {
	...
	void VerticalCollisions(ref Vector2 moveAmount) {
		...
		for (int i = 0; i < verticalRayCount; i ++) {
            ...
            Vector2 rayOrigin1 = raycastOrigins.topLeft;
            rayOrigin1 += Vector2.right * (verticalRaySpacing * i);
            RaycastHit2D hit1 = Physics2D.Raycast(rayOrigin1, Vector2.up, rayLength * 1.5f, collisionMask);

            Debug.DrawRay(rayOrigin1, Vector2.up, Color.green);
